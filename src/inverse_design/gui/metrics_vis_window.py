...
class MetricsVisualizationWindow:
    ...
    def update_plot(self):
        ...
        for idx, metric in enumerate(self.metric_names):
            ...
            ax.hist(all_values, bins=bins, alpha=0.3, density=True, label='All Samples', color='blue')
            ax.hist(accepted_values, bins=bins, alpha=0.3, density=True, label='Accepted Samples', color='orange')
