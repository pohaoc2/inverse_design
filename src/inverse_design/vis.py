...
def plot_parameter_kde(pdf_results: Dict, abc_config: Dict, save_path: str):
    ...
    # Add row titles
    fig.text(0.04, 0.75, "Uniform Prior Distribution", rotation=90, fontsize=10, va="center")
    fig.text(0.04, 0.35, "Posterior Distribution (KDE)", rotation=90, fontsize=10, va="center")
